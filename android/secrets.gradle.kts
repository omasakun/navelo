...
extra["MAPBOX_PRIVATE_TOKEN"] =
  secrets.getProperty("MAPBOX_PRIVATE_TOKEN") ?: error("MAPBOX_PRIVATE_TOKEN is missing")
extra["MAPBOX_PUBLIC_TOKEN"] =
  secrets.getProperty("MAPBOX_PUBLIC_TOKEN") ?: error("MAPBOX_PUBLIC_TOKEN is missing")
